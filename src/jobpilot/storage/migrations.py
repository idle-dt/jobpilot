"""Incremental schema and one-time data migrations.

Split out of database.py to keep that module under the 300-line limit. The public
entrypoint is run_migrations(); the rest are one-time migration steps invoked by it.
"""
